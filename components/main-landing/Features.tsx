...
const features = [
    {
        ...
        description: "Массивы, списки, деревья, графы, хеш-таблицы и куча — всё с примерами кода"
    },
    {
        icon: (
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
        ...
        title: "Алгоритмы",
        description: "Сортировки, поиск, обходы графов, динамическое программирование"
    },
    {
        icon: (
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
        ...
        title: "Примеры кода",
        description: "Читаемый TypeScript с комментариями и пояснениями асимптотики"
    }
];
