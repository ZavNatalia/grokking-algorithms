...
const algo = {
    ...
    description: (
        <>
            ...
            <p>Функция по нахождению факториала вычисляет <code>n!</code> рекурсивно. База: <code>0! = 1</code>, <code>1!= 1</code>.</p>
            <p>
                Для <code>n &gt; 1</code> возвращает
                <code>n * factorial(n - 1)</code>.
                Рекурсия последовательно уменьшает <code>n</code> до базы
                и затем «разворачивается» произведениями.
            </p>
        </>
    ),
    complexity: (
